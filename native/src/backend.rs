...
const BACKEND_NAME: &str = "notebooklm-fleet-mcp-backend.exe";
const BACKEND_PORT: u16 = 10783;
const BACKEND_TAG: &str = "notebooklm-fleet-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "NOTEBOOKLM_FLEET_MCP_PORT";
const ENV_HOST: &str = "NOTEBOOKLM_FLEET_MCP_HOST";
const ENV_TAURI: &str = "NOTEBOOKLM_FLEET_MCP_TAURI";
