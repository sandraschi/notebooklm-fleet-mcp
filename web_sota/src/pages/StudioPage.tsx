  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        Create audio/slides via MCP tools or <code>nlm audio create</code> / <code>nlm slides create</code>. This page
        polls artifact status.
      </p>
      ...
      {artifacts && (
        <pre className="text-xs glass p-4 rounded overflow-auto max-h-[480px]">{JSON.stringify(artifacts, null, 2)}</pre>
      )}
    </div>
  );
}
